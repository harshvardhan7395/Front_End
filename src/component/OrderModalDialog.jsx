            ...
            items.map((itm)=>{
                return(
                        <tr className="table-row" key={itm.id}>
                            <td className="px-4 py-2">{itm.dish_name}</td>
                            <td className="px-4 py-2">{itm.count}</td>
            ...
            <table className="table-auto">
                        ...
                        <tfoot>
                            <tr className="tabel-row">
                                <td className="px-4 py-2">Toatal Amount</td>
                                <td></td>
                                <td className="px-4 py-2">{this.totalCost()}</td>
                            </tr>
                        </tfoot>
                        </table>
                      
                <button onClick={this.props.isClose} className="text-white bg-red-500 hover:bg-red-700 rounded p-2 ml-8 mt-12 mb-4">Close</button>
                <button onClick={() => {this.props.pay();this.props.isClose()}} className="text-white bg-green-500 hover:bg-green-700 rounded p-2 ml-32  mb-4">PAY</button>
