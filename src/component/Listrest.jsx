            ...
            return(
                <div className=" relative ">
                    <div className="flex relative z-10 sticky top-0">
                        ...
                        <button  onClick={() =>{this.OrderHistory()}} className="bg-yellow-300 hover:text-red-700  text-lg text-black font-bold mt-16 py-2 px-4 ml-24 border-black border-2 rounded-full ">OrderHistory</button>
                        
                        {this.state.flag?
                        <button onClick={() => {this.setState({modelIsOpen:true})}} className="bg-yellow-300 hover:text-red-700  text-lg text-black font-bold mt-16 py-2 px-4 ml-24 border-black border-2 rounded-full ">+ Add Restaurant</button>
                        :null}
                        <button onClick={() =>{this.logout()}} className="bg-yellow-300 hover:text-red-700  text-lg text-black font-bold mt-16 py-2 px-4  ml-24  border-black border-2 rounded-full">Logout</button>
